...
/**
 * Footer — solo branding + enlaces + datos de ubicación.
 * El formulario de contacto vive ahora en /contact (accesible
 * desde el link "Contáctanos" del header) para que el footer
 * quede más limpio y los leads lleguen con intención explícita.
 */
